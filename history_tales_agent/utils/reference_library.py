...
def build_reference_prompt(
    ...
    *,
    ...
    prompt = (
        ...
        f"Source: A successful YouTube history video ({views_str} views, {duration} min)\n"
    ...
    if target_duration_minutes and ref_dur and isinstance(ref_dur, (int, float)) and ref_dur > 0:
        ...
        if ratio < 0.85:
            ...
            prompt += (
                ...
                "• PRESERVE the opening hook and the closing callback — these are\n"
            ...
            prompt += (
                ...
                f"• The reference uses {ref_segments} segments. Aim for roughly {ideal_segments}.\n"
                "• PRESERVE the opening hook and the closing callback unchanged.\n"
    ...
    prompt += (
        ...
        "1. HOOK MECHANICS: How does the first paragraph create urgency\n"
        "   before the listener understands context? What is withheld vs revealed?\n"
        ...
        "5. NARRATIVE QUESTION MANAGEMENT: Questions are posed, then answered 2–3\n"
        "   segments later — keeping the listener leaning forward.\n"
        ...
        "8. CLOSING CALLBACK: The ending returns to — and recontextualises — the\n"
