...
class RunStore:
    ...
    def list_runs(self, limit: int = 20) -> list[RunSummary]:
        ...
        return [RunSummary(**r.model_dump(exclude={"final_script", "sources_log", "claims", "qc_report", "errors", "script_elevenlabs_v3", "script_elevenlabs_flash", "script_speechify"})) for r in runs]
